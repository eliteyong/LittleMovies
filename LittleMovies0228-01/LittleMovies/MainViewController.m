...
- (void)creatCollectionView {
    ...
    UICollectionView *collection = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 40, kScreenW, kScreenH - 40) collectionViewLayout:layout];
    //这里设置collection的背景颜色
...
- (void)creatScreenAndFind {
    ...
    [self creatOneBtn:btnScreen withFrame:CGRectMake(0, 0, kScreenW / 2, 40) andTitle:@"筛选微电影"];
    ...
    [self creatOneBtn:btnFind withFrame:CGRectMake(kScreenW / 2, 0, kScreenW / 2, 40) andTitle:@"发现微电影"];
