...
#define kSliderTop 0
#define kSliderWidth kViewWidth - 175
#define kSliderHeight 40

#define kRepeatBtnX (kViewWidth - 80)/2
...
- (void)createMengBan {
//    UIView *view1 = [[UIView alloc] initWithFrame:self.AVPlayView.bounds];
//    view1.backgroundColor = [UIColor blackColor];
//    [self.AVPlayView addSubview:view1];
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    button.backgroundColor = [UIColor blackColor];
    
    button.frame = self.AVPlayView.bounds;
    [self.AVPlayView addSubview:button];
    [button setTitle:@"对不起,此影片暂时不能播放" forState:UIControlStateNormal];
}
