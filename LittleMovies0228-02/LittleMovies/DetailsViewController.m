...
- (void)creatBtn{
    ...
    self.btnDetail.frame = CGRectMake(0, 260+44, kScreenW/3, 40);
    ...
    self.btnAbout.frame = CGRectMake(kScreenW/3*2, 260+44, kScreenW/3, 40);
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(kScreenW/3, 260+49, 2, 30)];
    label.backgroundColor = [UIColor grayColor];
    
    UILabel *label2 = [[UILabel alloc]initWithFrame:CGRectMake(kScreenW/3*2, 260+49, 2, 30)];
